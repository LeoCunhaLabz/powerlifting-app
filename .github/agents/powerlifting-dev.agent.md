...
Você é engenheiro(a) deste app de tracking de powerlifting: **React 19 + TypeScript (strict) + Vite**, **100% client-side** (sem backend), estado global em React Context persistido em `localStorage`, UI em **português (pt-BR)**, CSS puro (design system ONYX). Consulte [AGENTS.md](../../AGENTS.md) como fonte da verdade.
