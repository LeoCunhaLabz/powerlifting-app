...
Contexto: leia [AGENTS.md](../../AGENTS.md) e [.github/copilot-instructions.md](../copilot-instructions.md). Respeite a stack e os limites do projeto (React 19 + TS strict + Vite, web client-side com `localStorage`, design system ONYX (CSS puro) em 480px, pt-BR, fase 2 introduzindo `apps/api` com Fastify + Postgres).
...
5. **UI/UX** — atrito em fluxos (Workout, Templates), feedback visual, estados vazio/carregando/erro, mobile-first 480px, acessibilidade (contraste, foco, labels), consistência com o design system ONYX.
