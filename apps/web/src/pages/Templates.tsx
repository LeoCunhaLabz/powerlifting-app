...
const styles: Record<string, React.CSSProperties> = {
  ...
  confirmDiscard: { flex: 1, height: '44px', backgroundColor: 'var(--error)', borderRadius: 'var(--radius-md)', fontSize: '13px', fontWeight: 800, color: 'var(--text-primary)' },
  ...
  toggleKnob: { position: 'absolute', top: '2px', left: 0, width: '18px', height: '18px', borderRadius: '50%', backgroundColor: 'var(--text-primary)', transition: 'transform 0.2s' } as React.CSSProperties,
